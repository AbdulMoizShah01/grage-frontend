...
export const WorkOrderHistoryPage = () => {
  ...
  const deleteHistoryDisclosure = useDisclosure();
  ...
  const requestWorkOrderDeletion = () => {
    if (!detail) {
      return;
    }
    setOrderPendingDelete(detail);
    deleteHistoryDisclosure.onOpen();
  };
  ...
  const handleDeleteWorkOrder = async () => {
    ...
    try {
      ...
      toast({ status: 'success', title: 'Work order deleted' });
      deleteHistoryDisclosure.onClose();
      closeOrderDetail();
    } catch (error) {
      toast({
        status: 'error',
  ...
  return (
    ...
    >
        ...
        <DrawerContent>
          ...
          {detail ? (
            <>
              ...
              <Box px={6} pb={4}>
                <Button colorScheme="red" variant="outline" onClick={requestWorkOrderDeletion} isDisabled={isDeleting}>
                  Delete Work Order
                </Button>
              </Box>
            </>
      ...
      <AlertDialog
        isOpen={deleteHistoryDisclosure.isOpen}
        onClose={deleteHistoryDisclosure.onClose}
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>
              {orderPendingDelete
                ? `Delete ${orderPendingDelete.code}? This action cannot be undone.`
                : 'Delete this work order?'}
            </AlertDialogBody>
            <AlertDialogFooter>
              <Button ref={deleteCancelRef} onClick={deleteHistoryDisclosure.onClose}>
                Cancel
              </Button>
              <Button colorScheme="red" onClick={handleDeleteWorkOrder} ml={3} isLoading={isDeletingOrder}>
                Delete
              </Button>
            </AlertDialogFooter>
          </AlertDialogContent>
